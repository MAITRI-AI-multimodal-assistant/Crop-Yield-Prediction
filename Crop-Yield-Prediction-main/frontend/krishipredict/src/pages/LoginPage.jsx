    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020805] px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/3 border border-white/8 rounded-2xl p-6 sm:p-8">
          <GoogleAuthButton label="Sign in with Google" onSuccess={redirectForRole} onError={setError} mode="login" />

          <div className="flex items-center gap-3 my-5">
            <div className="flex-1 h-px bg-white/8" />
            <span className="text-gray-500 text-xs font-semibold uppercase tracking-widest">or sign in with email</span>
            <div className="flex-1 h-px bg-white/8" />
          </div>
